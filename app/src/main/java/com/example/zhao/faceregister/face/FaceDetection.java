package com.example.zhao.faceregister.face;
...
import com.example.zhao.faceregister.context.MyApplication;
...
//		Imgproc.resize(rgbMat,rgbMat,new Size(640,480));
        ...
        mCascadeClassifier.detectMultiScale(grayMat, faces, 1.1, 0, 0, new Size(100, 100), new Size(400, 400));
